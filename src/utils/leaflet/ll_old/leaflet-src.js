  ...
  L.Mixin.Events = {
    ...
    addEventListener: function(types, fn, context) { // (String, Function[, Object]) or (Object[, Object])
      ...
      var events = this[eventsKey] = this[eventsKey] || {}
		    ...
		    var i; var len; var event; var type; var indexKey; var indexLenKey; var typeIndex
    ...
    removeEventListener: function(types, fn, context) { // ([String, Function, Object]) or (Object[, Object])
      ...
      var events = this[eventsKey]
		    var contextId = context && context !== this && L.stamp(context)
		    var i; var len; var type; var listeners; var j; var indexKey; var indexLenKey; var typeIndex; var removed
    ...
    fireEvent: function(type, data) { // (String[, Object])
      ...
      var events = this[eventsKey]
		    var listeners; var i; var len; var typeIndex; var contextId
      ...
      do {
        ...
        if (pos === 'relative' && !el.offsetLeft) {
          var width = L.DomUtil.getStyle(el, 'width')
				    var maxWidth = L.DomUtil.getStyle(el, 'max-width')
  ...
  L.Projection.SphericalMercator = {
    ...
    unproject: function(point) { // (Point, Boolean) -> LatLng
      var d = L.LatLng.RAD_TO_DEG
		    var lng = point.x * d
		    var lat = (2 * Math.atan(Math.exp(point.y)) - (Math.PI / 2)) * d
 ...
 */
  ...
  L.Map = L.Class.extend({
    ...
    panInsideBounds: function(bounds, options) {
      ...
      var newCenter = this._limitCenter(center, this._zoom, bounds)
    ...
    _limitOffset: function(offset, bounds) {
      ...
      var viewBounds = this.getPixelBounds()
		    var newBounds = new L.Bounds(viewBounds.min.add(offset), viewBounds.max.add(offset))
    ...
    _getBoundsOffset: function(pxBounds, maxBounds, zoom) {
      var nwOffset = this.project(maxBounds.getNorthWest(), zoom).subtract(pxBounds.min)
		    var seOffset = this.project(maxBounds.getSouthEast(), zoom).subtract(pxBounds.max)

		    var dx = this._rebound(nwOffset.x, -seOffset.x)
		    var dy = this._rebound(nwOffset.y, -seOffset.y)
  ...
  L.Projection.Mercator = {
    ...
    project: function(latlng) { // (LatLng) -> Point
      var d = L.LatLng.DEG_TO_RAD
		    ...
		    var r = this.R_MAJOR
		    var r2 = this.R_MINOR
		    var x = latlng.lng * d * r
		    var y = lat * d
		    var tmp = r2 / r
		    var eccent = Math.sqrt(1.0 - tmp * tmp)
		    var con = eccent * Math.sin(y)
    ...
    unproject: function(point) { // (Point, Boolean) -> LatLng
      var d = L.LatLng.RAD_TO_DEG
		    ...
		    var lng = point.x * d / r
		    var tmp = r2 / r
		    var eccent = Math.sqrt(1 - (tmp * tmp))
 ...
 */
  ...
  L.Icon.Default.imagePath = (function() {
    var scripts = document.getElementsByTagName('script')
	    var leafletRe = /[\/^]leaflet[\-\._]?([\w\-\._]*)\.js\??/
  ...
  L.Marker = L.Class.extend({
    ...
    _initIcon: function() {
      var options = this.options
		    ...
		    var classToAdd = animation ? 'leaflet-zoom-animated' : 'leaflet-zoom-hide'
 ...
 */
  ...
  L.Popup = L.Class.extend({
    ...
    _initLayout: function() {
      ...
      var containerClass = prefix + ' ' + this.options.className + ' leaflet-zoom-' +
  ...
  L.Map.include({
    _updatePathViewport: function() {
      var p = L.Path.CLIP_PADDING
		    var size = this.getSize()
		    var panePos = L.DomUtil.getPosition(this._mapPane)
  ...
  L.Map.include({
    ...
    _animatePathZoom: function(e) {
      var scale = this.getZoomScale(e.zoom)
		    var offset = this._getCenterOffset(e.center)._multiplyBy(-scale)._add(this._pathViewport.min)
    ...
    _updateSvgViewport: function() {
      ...
      var vp = this._pathViewport
		    ...
		    var pane = this._panes.overlayPane
  ...
  L.LineUtil = {
    ...
    clipSegment: function(a, b, bounds, useLastCode) {
      var codeA = useLastCode ? this._lastCode : this._getBitCode(a, bounds)
		    var codeB = this._getBitCode(b, bounds)
 ...
 */
  ...
  L.Polyline = L.Path.extend({
    ...
    closestLayerPoint: function(p) {
      var minDistance = Infinity; var parts = this._parts; var p1; var p2; var minPoint = null
    ...
    _convertLatLngs: function(latlngs, overwrite) {
      var i; var len; var target = overwrite ? latlngs : []
 ...
 */
  ...
  L.Circle = L.Path.extend({
    ...
    getBounds: function() {
      var lngRadius = this._getLngRadius()
		    var latRadius = (this._mRadius / 40075017) * 360
		    var latlng = this._latlng
 ...
 */
  ...
  L.Polyline.include(!L.Path.CANVAS ? {} : {
    _containsPoint: function(p, closed) {
      var i; var j; var k; var len; var len2; var dist; var part
		    var w = this.options.weight / 2
  ...
  L.Circle.include(!L.Path.CANVAS ? {} : {
    ...
    _containsPoint: function(p) {
      var center = this._point
		    var w2 = this.options.stroke ? this.options.weight / 2 : 0
 ...
 */
  ...
  L.DomEvent = {
    ...
    addListener: function(obj, type, fn, context) { // (HTMLElement, String, Function[, Object])
      var id = L.stamp(fn)
		    var key = '_leaflet_' + type + id
		    var handler; var originalHandler; var newType
  ...
  L.Map.Drag = L.Handler.extend({
    ...
    _onDrag: function() {
      if (this._map.options.inertia) {
        var time = this._lastTime = +new Date()
			    var pos = this._lastPos = this._draggable._newPos
    ...
    _onDragEnd: function(e) {
      var map = this._map
		    ...
		    var delay = +new Date() - this._lastTime

		    var noInertia = !options.inertia || delay > options.inertiaThreshold || !this._positions[0]
      ...
      if (noInertia) {
        ...
        var direction = this._lastPos.subtract(this._positions[0])
			    var duration = (this._lastTime + delay - this._times[0]) / 1000
  ...
  L.Map.TouchZoom = L.Handler.extend({
    ...
    _onTouchStart: function(e) {
      ...
      var p1 = map.mouseEventToLayerPoint(e.touches[0])
		    var p2 = map.mouseEventToLayerPoint(e.touches[1])
		    var viewCenter = map._getCenterLayerPoint()
    ...
    _onTouchEnd: function() {
      ...
      var origin = this._getScaleOrigin()
		    ...
		    var floatZoomDelta = map.getScaleZoom(this._scale) - oldZoom
		    var roundZoomDelta = (floatZoomDelta > 0
		            ? Math.ceil(floatZoomDelta) : Math.floor(floatZoomDelta))

		    var zoom = map._limitZoom(oldZoom + roundZoomDelta)
		    var scale = map.getZoomScale(zoom) / this._scale
 ...
 */
  ...
  L.Map.include(!L.DomUtil.TRANSITION ? {} : {
    ...
    _tryAnimatedZoom: function(center, zoom, options) {
      ...
      var origin = this._getCenterLayerPoint()._add(offset)
  ...
  L.TileLayer.include({
    _animateZoom: function(e) {
      ...
      var bg = this._bgBuffer
		    ...
		    var initialTransform = e.delta ? L.DomUtil.getTranslateString(e.delta) : bg.style[transform]
    ...
    _prepareBgBuffer: function() {
      ...
      var bgLoaded = this._getLoadedTilesPercentage(bg)
		    var frontLoaded = this._getLoadedTilesPercentage(front)
 ...
 */
  ...
  L.Map.include({
    ...
    locate: function(/* Object*/ options) {
      ...
      var onError = L.bind(this._handleGeolocationError, this)
    ...
    _handleGeolocationResponse: function(pos) {
      var lat = pos.coords.latitude
		    ...
		    var latAccuracy = 180 * pos.coords.accuracy / 40075017
