...
// distance.js - Distance mixins for Paths
  ...
  var calcArea = function(coordArray) {
    var area = 0; var i; var l; var c1; var c2
  ...
  var calcCenter = function(coordArray) {
    var offset = coordArray[0]; var twiceArea = 0; var x = 0; var y = 0; var i; var l; var c1; var c2; var f
...
// distance.js - Distance mixins for Paths
  ...
  var calcDistance = function(coord1, coord2) {
    ...
    var deltaLat = units.degrees.toRadians(coord1[1] - coord2[1])
    var lat1 = units.degrees.toRadians(coord1[1])
    var lat2 = units.degrees.toRadians(coord2[1])
    var hvsLng = Math.sin(deltaLng / 2)
    var hvsLat = Math.sin(deltaLat / 2)
...
//     Underscore may be freely distributed under the MIT license.
  ...
  // Baseline setup
    ...
    var ArrayProto = Array.prototype; var ObjProto = Object.prototype; var FuncProto = Function.prototype
    ...
    _.sortedIndex = function(array, obj, iterator, context) {
      ...
      var low = 0; var high = array.length
      while (low < high) {
        var mid = (low + high) >>> 1
...
//     Underscore may be freely distributed under the MIT license.
  ...
  // Baseline setup
    ...
    _.bindAll = function(obj) {
      var i; var length = arguments.length; var key
    ...
    _.matches = function(attrs) {
      var pairs = _.pairs(attrs); var length = pairs.length
      return function(obj) {
        if (obj == null) return !length
        obj = new Object(obj)
        for (var i = 0; i < length; i++) {
          var pair = pairs[i]; var key = pair[0]
...
// measure calculations
  ...
  var ddToDms = function(coordinate, posSymbol, negSymbol) {
    ...
    var s = Math.round((dd - d - (m / 60)) * 3600 * 100) / 100
    var directionSymbol = dd === coordinate ? posSymbol : negSymbol
    return pad(d) + '&deg; ' + pad(m) + '\' ' + pad(s) + '" ' + directionSymbol
  }

  var measure = function(latlngs) {
    var last = _.last(latlngs); var feet; var meters; var miles; var kilometers; var sqMeters; var acres; var hectares; var sqMiles
  ...
  (function(global) {
    ...
    L.Control.Measure = L.Control.extend({
      ...
      _initLayout: function() {
        var className = this._className; var container = this._container = L.DomUtil.create('div', className)
      ...
      _handleMeasureDoubleClick: function() {
        var latlngs = this._latlngs; var calced; var resultFeature; var popupContainer; var popupContent; var zoomLink; var deleteLink
      ...
      _handleMeasureClick: function(evt) {
        var latlng = evt.latlng; var lastClick = _.last(this._latlngs); var vertexSymbol = this._symbols.getSymbol('measureVertex')
